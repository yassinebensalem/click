...
namespace DDD.Infra.Data.Migrations
{
    ...
    [Migration("20230822004201_CreateTableWalletTransaction")]
    partial class CreateTableWalletTransaction
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DDD.Domain.Models.Community", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DDD.Domain.Models.CommunityMember", b =>
                {
                    ...
                    b.Property<bool>("IsCommunityAdmin")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DDD.Domain.Models.JoinRequest", b =>
                {
                    ...
                    b.Property<string>("DesiredBooks")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DDD.Domain.Models.PromoUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("BooksTakenCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DDD.Domain.Models.WalletTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DDD.Domain.Models.CommunityMember", b =>
                {
                    b.HasOne("DDD.Domain.Models.Community", "Community")
                        .WithMany("Members")
                        .HasForeignKey("CommunityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DDD.Domain.Models.ApplicationUser", "Member")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("DDD.Domain.Models.WalletTransaction", b =>
                {
                    ...
                    b.HasOne("DDD.Domain.Models.Community", null)
                        .WithMany("WalletTransactions")
                        .HasForeignKey("CommunityId");
                });
